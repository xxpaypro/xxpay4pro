...
public class SubuserRoleController extends BaseController {
    ...
    public ResponseEntity<?> get() {
        ...
        SysRole sysRole = rpcCommonService.rpcSysService.findRoleById(MchConstant.INFO_TYPE_AGENT, getUser().getBelongInfoId(), roleId);
    ...
    public ResponseEntity<?> add() {
        ...
        sysRole.setBelongInfoType(MchConstant.INFO_TYPE_AGENT);
    ...
    public ResponseEntity<?> update() {
        ...
        SysRole dbRecord = rpcCommonService.rpcSysService.findRoleById(MchConstant.INFO_TYPE_AGENT, getUser().getBelongInfoId(), sysRole.getRoleId());
    ...
    public ResponseEntity<?> delete() {
        ...
        rpcCommonService.rpcSysService.batchDeleteRole(MchConstant.INFO_TYPE_AGENT, getUser().getBelongInfoId(), rids);
        return ResponseEntity.ok(BizResponse.buildSuccess());
    }
    ...
    public ResponseEntity<?> viewPermission() {
        ...
        // 得到系统下所有资源
        List<SysResource> sysResourceList = rpcCommonService.rpcSysService.selectAllResource(MchConstant.INFO_TYPE_AGENT);
