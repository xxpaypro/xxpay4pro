package org.xxpay.agent.profit;
...
public class OrderProfitController extends BaseController {
    ...
    public XxPayResponse list() {
        ...
        orderProfitTask.setAgentPid(getUser().getBelongInfoId());  //仅查询当前代理商的直接下属代理商
    ...
    private OrderProfitTask getAvailableSettTask(){
        ...
        //禁止越权查询
        if(!getUser().getBelongInfoId().equals(orderProfitTask.getAgentPid())){
