...
public class SubuserRoleController extends BaseController {
    ...
    public ResponseEntity<?> get() {
        ...
        SysRole sysRole = rpcCommonService.rpcSysService.findRoleById(MchConstant.INFO_TYPE_MCH, getUser().getBelongInfoId(), roleId);
    ...
    public ResponseEntity<?> add() {
        ...
        sysRole.setBelongInfoType(MchConstant.INFO_TYPE_MCH);
    ...
    public ResponseEntity<?> update() {
        ...
        SysRole dbRecord = rpcCommonService.rpcSysService.findRoleById(MchConstant.INFO_TYPE_MCH, getUser().getBelongInfoId(), sysRole.getRoleId());
    ...
    public ResponseEntity<?> delete() {
        ...
        rpcCommonService.rpcSysService.batchDeleteRole(MchConstant.INFO_TYPE_MCH, getUser().getBelongInfoId(), rids);
        return ResponseEntity.ok(BizResponse.buildSuccess());
    }
