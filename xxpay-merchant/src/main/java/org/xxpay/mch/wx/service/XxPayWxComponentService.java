...
public class XxPayWxComponentService {
    ...
    /** 商户接口   GET请求**/
    public JSONObject reqWXByMchGET(Long mchId, Byte authFrom, String reqUrl, String params) throws Exception {
    ...
    /** 通用请求微信接口   GET请求**/
    public static JSONObject reqWXGET(String reqUrl, String params) throws WxErrorException{
        ...
        if (params == null){
            ...
            responseContent = reqService.get(reqUrl, params);
        }
        return (JSONObject)JSONObject.parse(responseContent);
    }
