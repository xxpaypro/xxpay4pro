...
public class RechargeController {
    ...
    public String recharge(@RequestParam String params) {
        ...
        try {
            ...
            if(obj == null) return XXPayUtil.makeRetFail(XXPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "账户充值失败", null, PayEnum.ERR_0010.getCode(), "账户充值失败"));
            ...
            if(result != 1) {
                return XXPayUtil.makeRetFail(XXPayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "账户充值失败", null, PayEnum.ERR_0010.getCode(), "DB操作失败"));
            }
