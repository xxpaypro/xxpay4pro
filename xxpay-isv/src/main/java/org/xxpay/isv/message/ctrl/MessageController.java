package org.xxpay.isv.message.ctrl;
 ...
 */
@RestController
@RequestMapping(Constant.ISV_CONTROLLER_ROOT_PATH + "/message")
...
public class MessageController extends BaseController {
    ...
    public ResponseEntity<?> get() {
        ...
        if(sysMessage == null || !sysMessage.getIsvStatus().equals(MchConstant.PUB_YES)){     //判断是否可查看
    ...
    public ResponseEntity<?> list() {
        ...
        sysMessage.setIsvStatus(MchConstant.PUB_YES);
