package org.xxpay.isv.common.util;
...
public class AliSmsUtil {
     ...
     * @param code 验证码
     * @param bizType 业务类型
     * @param configStr 系统配置参数
     * @return 是否成功
     * @throws ClientException
     */
    public static boolean sendSms(Long phoneNumber, String code, Byte bizType, String configStr){
        ...
        JSONObject configJSON = (JSONObject)JSONObject.parse(configStr);
